...
export default function Home() {
  return (
    <div>
      <div className="flex flex-col items-center bg-luna-blue text-luna-beige">
        ...
        <div className="md:w-3/5 flex flex-col items-center px-5">
          <div className="mt-10 text-center">
            <p className="text-lg leading-tight">
              ...
              products, leading to negative health outcomes, increased
              absenteeism from school and work, and a detrimental impact on
              overall wellbeing.
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            <p className="text-lg leading-tight">
              ...
              periods with dignity and confidence, contributing to a society
              where no one is held back by the challenges of period poverty.
            </p>
          </div>
        </div>
      </div>
