    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-blue-50 to-white px-4 py-24 text-center md:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          ...
          <p className="mx-auto max-w-[700px] text-lg text-muted-foreground md:text-xl">
            We are a student-led non-profit dedicated to empowering young people.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16 md:px-6 lg:px-8">
        <div className="mx-auto max-w-[800px] space-y-8">
          <h2 className="text-3xl font-bold tracking-tighter text-center md:text-4xl">Our Story</h2>
          <div className="prose prose-blue mx-auto max-w-none">
            <p className="text-muted-foreground leading-relaxed">
              The Luna Initiative was founded in 2020 by UCL students with the aim to have a positive social impact.
              Since 2020, we have engaged in a number of different projects, all with the underlying goal of making the
              world a better place. This year, we are running educational workshops in schools across the UK, as we
              think that this will have the biggest social impact, given our skills, capabilities and knowledge. We
              currently operate as both a social enterprise and a charity as this gives us the flexibility to engage in
              a greater range of different projects and activities.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
              Our workshops bridge the gap between classroom learning and essential life skills, helping students build
              confidence and succeed in their future endeavors. We believe that education should be accessible,
              engaging, and relevant to today's challenges.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Values Section */}
      <section className="container mx-auto px-4 py-16 md:px-6 lg:px-8">
        <h2 className="text-3xl font-bold tracking-tighter text-center mb-12 md:text-4xl">Our Values</h2>
        <div className="grid gap-8 md:grid-cols-3">
          <Card className="group relative overflow-hidden transition-all hover:shadow-lg">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                We believe in equipping young people with the knowledge and confidence they need to take control of
                their future.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group relative overflow-hidden transition-all hover:shadow-lg">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Education should be accessible to all, regardless of background or circumstances. We work to break down
